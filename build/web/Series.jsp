...
<html>
    <head>
        <title>Comics Book Recommender - Search by Series</title>
        ...
        <script type="text/javascript" src="./resources/SeriesNames.js"></script>
        ...
        <script>	
            function AddToInputArray(inputPlace){
                ...
                for (var i=0;i<SeriesNames.length;i++){
                    if (SeriesNames[i].toLowerCase()==inputPlace.toLowerCase()){
                        InputChecker=1;
                    }
                }
                if (InputChecker>0){
                    ...
                    $("#FeedbackParagraph1").html("<p style='text-align:center;'>You have not entered a valid series name, please enter another selection</p>");
                }
                ...
                <div id="sitebody">				
                    ...
                    <form method="post">
                        <div id="sitepage">
                            ...
                            <div id="FormInputs">
                                <h2 style="text-align:center;">Search by Series</h2>
                                <p><em>Step 1:</em><br>Type in the names of Series you like, then click "Add". Do this for as many series as you want, the more names you enter the higher the accuracy.</p> 
                                <div class="CenterObject" >
                                    <input style="height:1.8em;width:24em;font-size:1.25em;padding-left:0.625em;float:left;margin:0 0.5em 0 0;" type="text" id="CharacterNamesClientInput" name="SearchNameBox" placeholder="Search Series Names" />
                        ...
                        <div id="sitepage2">
                            ...
                            <% 
                                if(SearchNameString!=""){
                                    ...
                                    out.println("<table style='margin-left:15em;' ><tr><td style='width:12.5em;'><ul class='alpha'>");
                                    out.println("<li class='AddListClicked'>100 Bullets</li>");
                                    out.println("<li class='AddListClicked'>Ultimate Spider-Man</li>");
                                    out.println("<li class='AddListClicked'>Chew</li>");
                                    out.println("<li class='AddListClicked'>Saga</li>");
                                    out.println("<li class='AddListClicked'>Uncanny X-Force</li>");
                                    out.println("<li class='AddListClicked'>Hellblazer</li>");
                                    out.println("<li class='AddListClicked'>Powers</li>");
                                    out.println("<li class='AddListClicked'>Planetary</li>");
                                    out.println("<li class='AddListClicked'>Secret War</li>");
                                    out.println("<li class='AddListClicked'>The Immortal Iron Fist</li>");
                                    out.println("</ul></td><td><ul class='alpha'>");
                                    out.println("<li class='AddListClicked'>Spaceman</li>");
                                    out.println("<li class='AddListClicked'>The Boys</li>");
                                    out.println("<li class='AddListClicked'>Sweet Tooth</li>");
                                    out.println("<li class='AddListClicked'>Watchmen</li>");
                                    out.println("<li class='AddListClicked'>Detective Comics</li>");
                                    out.println("<li class='AddListClicked'>The Walking Dead</li>");
                                    out.println("<li class='AddListClicked'>Sandman</li>");
                                    out.println("<li class='AddListClicked'>Y: The Last Man</li>");
                                    out.println("<li class='AddListClicked'>Scott Pilgrim</li>");
                                    out.println("<li class='AddListClicked'>Batman: The Long Halloween</li></ul></td></tr></table>");
                                }
                            %>
                            </div>			
                        </div>
