...
<html>
    <head>
        <title>Comics Book Recommender - Search by Characters</title>
        ...
        <script type="text/javascript" src="./resources/CharacterNames.js"></script> 
        ...
        <script>
            function AddToInputArray(inputPlace){
                ...
                for (var i=0;i<CharacterNames.length;i++){
                    if (CharacterNames[i].toLowerCase()==inputPlace.toLowerCase()){
                        InputChecker=1;
                    }
                }
                if (InputChecker>0){
                    ...
                    $("#FeedbackParagraph1").html("<p style='text-align:center;'>You have not entered a valid character's Name, please enter another selection</p>");
                }
                ...
                <div id="sitebody">				
                    ...
                    <form method="post">
                        <div id="sitepage">
                            ...
                            <div id="FormInputs">
                                <h2 style="text-align:center;">Search By Characters</h2>
                                <p><em>Step 1:</em><br>Type in the names of a Character you like, then click "Add". Do this for as many characters as you want, the more names you enter the higher the accuracy.</p> 
                                <div class="CenterObject" >
                                    <input style="height:1.8em;width:24em;font-size:1.25em;padding-left:0.625em;float:left;margin:0 0.5em 0 0;" type="text" id="CharacterNamesClientInput" name="SearchNameBox" placeholder="Search Character Names" />
                        ...
                        <div id="sitepage2">
                            ...
                            <% 
                                if(SearchNameString!=""){
                                    ...
                                    out.println("<li class='AddListClicked'>Batman</li>");
                                    out.println("<li class='AddListClicked'>Spider-Man</li>");
                                    out.println("<li class='AddListClicked'>Superman</li>");
                                    out.println("<li class='AddListClicked'>Green Arrow</li>");
                                    out.println("<li class='AddListClicked'>Hulk</li>");
                                    out.println("<li class='AddListClicked'>Wonder Woman</li>");
                                    out.println("<li class='AddListClicked'>The Flash</li>");
                                    out.println("<li class='AddListClicked'>Daredevil</li>");
                                    out.println("<li class='AddListClicked'>Aquaman</li>");
                                    out.println("<li class='AddListClicked'>Black Widow</li>");
                                    out.println("</ul></td><td><ul class='alpha'>");
                                    out.println("<li class='AddListClicked'>Green Lantern</li>");
                                    out.println("<li class='AddListClicked'>Captain America</li>");
                                    out.println("<li class='AddListClicked'>Iron Man</li>");
                                    out.println("<li class='AddListClicked'>Spawn</li>");
                                    out.println("<li class='AddListClicked'>Wolverine</li>");
                                    out.println("<li class='AddListClicked'>John Constantine</li>");
                                    out.println("<li class='AddListClicked'>Bane</li>");
                                    out.println("<li class='AddListClicked'>Deadpool</li>");
                                    out.println("<li class='AddListClicked'>Nightwing</li>");
                                    out.println("<li class='AddListClicked'>Judge Dredd</li></ul></td></tr></table>");
                                }
                            %>
                            </div>			
                        </div>
